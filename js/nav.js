  ...
  <nav class="topbar">
    <div style="display:flex;align-items:center;gap:3rem">
      ...
      <div class="nav-links">
        ...
        <a href="training.html" ${activePage==='training'?'class="active"':''}>Training</a>
      </div>
    </div>
      ...
      <div style="display:flex;flex-wrap:wrap;justify-content:space-between;gap:3rem;margin-bottom:3rem">
        ...
        <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:3rem">
          <div style="display:flex;flex-direction:column;gap:0.75rem">
            ...
            <a href="events.html" style="color:var(--on-surface-variant);text-decoration:none;font-size:0.9rem;transition:color 0.2s" onmouseover="this.style.color='#fff'" onmouseout="this.style.color='var(--on-surface-variant)'">Events</a>
            <a href="training.html" style="color:var(--on-surface-variant);text-decoration:none;font-size:0.9rem;transition:color 0.2s" onmouseover="this.style.color='#fff'" onmouseout="this.style.color='var(--on-surface-variant)'">Training</a>
            <a href="#" style="color:var(--on-surface-variant);text-decoration:none;font-size:0.9rem;transition:color 0.2s" onmouseover="this.style.color='#fff'" onmouseout="this.style.color='var(--on-surface-variant)'">Community</a>
          </div>
          <div style="display:flex;flex-direction:column;gap:0.75rem">
